...
/// SOURCE_FILES is generated by build.rs — it reads every .json in src/sources/
/// at compile time, so adding a new source requires only dropping a new file there.
