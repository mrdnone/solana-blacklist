  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="w-full rounded-[2px] border border-white/[0.55] py-3 pl-11 pr-4 text-[0.85rem] text-text-primary placeholder-text-muted outline-none focus:border-white/[0.85] transition-all duration-300 font-body"
      />
      {value && (
        <button
          onClick={() => onChange('')}
